...
<head>
    ...
    <script type="text/javascript" src="js/validacionesRegistroPJ.js"></script>
            ...
            <div class="contenidoCaja">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-8 col-lg-4">
                        ...
                        <input id="txtRS" type="text" class="form-control inputIconoInterno" placeholder="Ingresa la Razon social" onkeypress="return soloLetras(event)" maxlength="20" required/>
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input id="txtFantasyName" type="text" class="form-control inputIconoInterno" placeholder="Nombre de Fantasia" onkeypress="return soloLetras(event)" maxlength="20" required/>
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        <label class="labelLeft">Identificacion Tributaria</label><img class="imgQuestion" src="img/icons/smallIcons/question.png">  
                        <span class="iconoInterno" id="basic-addon1"><img src="img/icons/smallIcons/id-card.png" alt="@"/></span>
                        <input id="txtIT" type="number" class="form-control inputIconoInterno" placeholder="Ingresa el N° de IT" onkeypress="return soloNumeros(event)" maxlength="20" required />
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-8 col-lg-4">
                        <label class="labelLeft">Forma Juridica</label>
                            ...
                            <select class="form-control inputIconoInterno" id="cmbDocumento" required>
                                <option disabled selected>S.R.L</option>
                                <option>S.A</option>
                            </select>
                    </div>
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input id="dtpFundationDate" type="date" class="form-control inputIconoInterno" required/>
                    </div>
