        ...
        <div class="contenidoCajaFija">
            <form>
                ...
                <div class="form-group grupo1">
                        ...
                        <input id="txtMail" type="mail" class="form-control inputIconoInterno" placeholder="E-mail">
                ...
                <div class="form-group itemsLinear">
                    <div class="custom-control custom-radio margin-right">
                        <input type="radio" class="custom-control-input" id="optPersona" name="defaultExampleRadios">
                        <label class="custom-control-label" for="optPersona">Individual</label>
                    </div>
                    <div class="custom-control custom-radio margin-left">
                        <input type="radio" class="custom-control-input" id="optEmpresa" name="defaultExampleRadios">
